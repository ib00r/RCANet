...
class Unet(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        "model_path"    : './logs/scse_carafe_ep090-loss0.321-val_loss0.323.pth',#scse_carafe_ep090-loss0.321-val_loss0.323.pth
        #--------------------------------#
        #   所需要区分的类的个数+1
        #--------------------------------#
        # "num_classes"   : 21,
    ...
    def generate(self, onnx=False):
        ...
        self.net = SCSEUnet(in_channel=3, out_channel=2)
    ...
    def detect_image(self, image, count=False, name_classes=None):
        ...
        #---------------------------------------------------------#
        #   添加上batch_size维度       transpose将图片的通道数调换到最前面 expand_dims扩展batch_size维度，expand_dims(a, aix) 在a的aix轴增加一个维度   preprocess_input进行了归一化
        #---------------------------------------------------------#
